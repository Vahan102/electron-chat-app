...
addButton.addEventListener("click", () => {
    if (addCount == 0) {
        ...
        addGroupButton.addEventListener("click", () => {
            ...
            createGroupButton.addEventListener("click", () => __awaiter(void 0, void 0, void 0, function* () {
                return yield sendRequest("createGroup", "POST", "createGroup", token, {
                    name: groupName.value,
                    img: imagesArr[num]
                }).then((res) => __awaiter(void 0, void 0, void 0, function* () {
                    groupName.value = "";
                    console.log(res);
                    yield createGroup(res.link, res.name, "external", imagesArr[num]);
                }));
            }));
        });
        searchGroupButton.addEventListener("click", () => {
            ...
            box.appendChild(groupName);
            box.appendChild(searchGroupButton);
            searchGroupButton.addEventListener("click", () => __awaiter(void 0, void 0, void 0, function* () {
                return yield sendRequest("joinGroup", "POST", "joinGroup", token, {
                    link: groupName.value
                }).then((res) => __awaiter(void 0, void 0, void 0, function* () {
                    getRequest("searchGroup", token, { link: groupName.value }).then((res) => __awaiter(void 0, void 0, void 0, function* () {
                        console.log(res);
                        yield createGroup(res.data[0].link, res.data[0].name, "internal", res.data[0].img);
                    }));
                }));
            }));
        });
